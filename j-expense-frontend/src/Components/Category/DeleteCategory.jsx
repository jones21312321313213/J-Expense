...
function DeleteCategory({ name, onClose, onDelete }) {
    ...
    padding: "14px",
    borderRadius: "50%",
    backgroundColor: "#FEF3F2", // outer circle color
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    };
    ...
    padding: "10px",
    borderRadius: "50%",
    backgroundColor: "#FFEBEE", // inner circle
    display: "flex",
    justifyContent: "center",
    alignItems: "center",
    };
    ...
    const deleteHandler = async () => {
        ...
        // BACKEND DELETE WILL BE IMPLEMENTED HERE
        onDelete();
    };
        ...
        <div style={modalOverlay}>
            <div style={modalBox}>
                ...
                <div style={contentAreaStyle}>
                    ...
                    {/* Text Content */}
                    <div>
                        <h2 style={titleStyle}>Delete Category?</h2>
